...
const NewRoom = () => {
  ...
  const arrowLeftIcon = (
    <AntDesign name='arrowleft' size={24} color='#4754BA' />
  );

  const setSelectedComponent = newRoomStore(
        ...
        <View style={{ marginTop: 30 }}>
          ...
          <View>
            ...
            <ScrollView horizontal showsHorizontalScrollIndicator={false}>
              <View style={styles.chipContainer}>
                <Chip
                  style={
                    data.tipoHabitacion.includes('individual')
                      ? styles.selectedChip
                      : styles.chip
                  }
                  icon={
                  ...
                  onPress={() => selectedChip('tipoHabitacion', 'individual')}
                >
                  Individual
                </Chip>
                <Chip
                  style={
                    data.tipoHabitacion.includes('compartida')
                      ? styles.selectedChip
                      : styles.chip
                  }
                  icon={
                  ...
                  onPress={() => selectedChip('tipoHabitacion', 'compartida')}
                >
                  Compartida
                </Chip>
                <Chip
                  style={
                    data.tipoHabitacion.includes('alojamiento entero')
                      ? styles.selectedChip
                      : styles.chip
                  }
                  icon={
                  ...
                  onPress={() =>
                    selectedChip('tipoHabitacion', 'alojamiento entero')
                  }
                >
                  Alojamiento entero
                </Chip>
          ...
          <View>
            ...
            <View style={styles.chipContainer}>
              <Chip
                style={
                  data.tipoPropiedad.includes('casa')
                    ? styles.selectedChip
                    : styles.chip
                }
                icon={
                  data.tipoPropiedad.includes('casa') ? () => checkIcon : null
                }
              ...
              <Chip
                style={
                  data.tipoPropiedad.includes('departamento')
                    ? styles.selectedChip
                    : styles.chip
                }
                icon={
                ...
                onPress={() => selectedChip('tipoPropiedad', 'departamento')}
              >
                Departamento
              </Chip>
            </View>
          ...
          <View>
            ...
            <ScrollView horizontal showsHorizontalScrollIndicator={false}>
              <View style={styles.chipContainer}>
                <Chip
                  style={
                    data.servicios.includes(1)
                      ? styles.selectedChip
                      : styles.chip
                  }
                  icon={data.servicios.includes(1) ? () => checkIcon : null}
                  onPress={() => selectedChip('servicios', 1)}
                >
                  Wifi
                </Chip>
                <Chip
                  style={
                    data.servicios.includes(2)
                      ? styles.selectedChip
                      : styles.chip
                  }
                  icon={data.servicios.includes(2) ? () => checkIcon : null}
                  onPress={() => selectedChip('servicios', 2)}
                >
                  Cocina
                </Chip>
                <Chip
                  style={
                    data.servicios.includes(3)
                      ? styles.selectedChip
                      : styles.chip
                  }
                  icon={data.servicios.includes(3) ? () => checkIcon : null}
                  onPress={() => selectedChip('servicios', 3)}
                >
                  Estacionamiento
                </Chip>
                <Chip
                  style={
                    data.servicios.includes(4)
                      ? styles.selectedChip
                      : styles.chip
                  }
                  icon={data.servicios.includes(4) ? () => checkIcon : null}
                  onPress={() => selectedChip('servicios', 4)}
                >
                  Lavadora
                </Chip>
                <Chip
                  style={
                    data.servicios.includes(5)
                      ? styles.selectedChip
                      : styles.chip
                  }
                  icon={data.servicios.includes(5) ? () => checkIcon : null}
                  onPress={() => selectedChip('servicios', 5)}
                >
                  Secadora
                </Chip>
                <Chip
                  style={
                    data.servicios.includes(6)
                      ? styles.selectedChip
                      : styles.chip
                  }
                  icon={data.servicios.includes(6) ? () => checkIcon : null}
                  onPress={() => selectedChip('servicios', 6)}
                >
                  A/C
                </Chip>
                <Chip
                  style={
                    data.servicios.includes(7)
                      ? styles.selectedChip
                      : styles.chip
                  }
                  icon={data.servicios.includes(7) ? () => checkIcon : null}
                  onPress={() => selectedChip('servicios', 7)}
                >
                  Calefacción
                </Chip>
                <Chip
                  style={
                    data.servicios.includes(8)
                      ? styles.selectedChip
                      : styles.chip
                  }
                  icon={data.servicios.includes(8) ? () => checkIcon : null}
                  onPress={() => selectedChip('servicios', 8)}
                >
                  TV
                </Chip>
              </View>
